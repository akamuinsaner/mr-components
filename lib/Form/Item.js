...
var FormItem = function (_a) {
    ...
    var instance = context.instance, size = context.size, disabled = context.disabled, layout = context.layout, itemProps = context.gridProps.itemProps, fullWidth = context.fullWidth;
    ...
    _this.current = __assign(__assign({}, _this.current), { element: itemRef.current, setError: _setError, setValue: _setValue, getValue: _getValue, validate: _validate });
    ...
    var preChildren = React.cloneElement(subComponent, __assign(__assign({ ref: itemRef, size: size, disabled: disabled, fullWidth: fullWidth }, subComponent.props), props));
    if (layout === 'Grid') {
