...
export declare const getDataDisplay: (dataSource: any[], pagination: Partial<TablePaginationProps> | false, pageParams: Partial<TablePaginationProps>, sortParams: RecordTableSortParams, filterParams: {
...
export declare const getFixedWidth: (columns: RecordTableColumn<any>[], key: any) => number;
export declare const getFixedStyle: (fixed: 'left' | 'right', columns: RecordTableColumn<any>[], key: any) => {};
