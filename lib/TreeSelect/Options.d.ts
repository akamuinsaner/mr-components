...
declare const _default: ({ dense, expandKeys, expandAll, showCheck, search, multiple, selected, inputValue, flatOptions, setSelected, allChildrenMap, setFlattedOptions, loadData }: Props) => any;
