...
var TreeSelect = function (_a) {
    ...
    var _q = __read(React.useState(Array.isArray(value) ? value : (value ? [value] : [])), 2), selected = _q[0], setSelected = _q[1];
    ...
    var renderInput = function (params) {
        ...
        return (_jsx(TextField, __assign({}, params, inputProps, { onClick: function (e) { return e.stopPropagation(); }, focused: isFocus, ref: inputRef, placeholder: (isFocus && !multiple) ? renderValue() : inputProps.placeholder, sx: {
