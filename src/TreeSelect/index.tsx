...
import { ListItem, TextFieldProps } from '@mui/material';
import TextField from '@mui/material/TextField';
import ArrowDropDownIcon from '@mui/icons-material/ArrowDropDown';
import { flatOptions, idAllChildrenMap, idChildrenMap, reservedKey } from './helper';
    ...
    const renderInput = (params) => {
        ...
        return (
            <TextField
                ...
                focused={isFocus}
                placeholder={(isFocus && !multiple) ? selected[0] : inputProps.placeholder}
                sx={{
